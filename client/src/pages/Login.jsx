          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link to="/forgot-password" className="text-xs text-brand-700 hover:underline font-medium">Forgot password?</Link>
              </div>
            ...
            {isGoogleConfigured() && (
              <>
                <div className="relative my-2">
                  ...
                  <div className="relative flex justify-center"><span className="bg-ink-50 px-3 text-xs text-ink-500">or</span></div>
                </div>
