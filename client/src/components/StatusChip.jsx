const MAP = {
  ...
  'Ready for QA':           { bg: 'bg-purple-50',  text: 'text-purple-700',  border: 'border-purple-200' },
  'In QA Testing':          { bg: 'bg-fuchsia-50', text: 'text-fuchsia-700', border: 'border-fuchsia-200' },
  'QA Failed':              { bg: 'bg-red-50',     text: 'text-red-700',     border: 'border-red-200' },
  'Verified by QA':         { bg: 'bg-emerald-50', text: 'text-emerald-700', border: 'border-emerald-200' },
  'Approved by PM':         { bg: 'bg-green-50',   text: 'text-green-700',   border: 'border-green-200' },
  'Done':                   { bg: 'bg-brand-50',   text: 'text-brand-700',   border: 'border-brand-200' },
  'Reopened':               { bg: 'bg-orange-50',  text: 'text-orange-700',  border: 'border-orange-200' },
  'Deferred':               { bg: 'bg-ink-100',    text: 'text-ink-600',     border: 'border-ink-200' },
  'Duplicate':              { bg: 'bg-ink-100',    text: 'text-ink-600',     border: 'border-ink-200' },
  'Rejected':               { bg: 'bg-ink-100',    text: 'text-ink-600',     border: 'border-ink-200' },
  // Legacy
  ...
  'Failed QA':              { bg: 'bg-red-50',     text: 'text-red-700',     border: 'border-red-200' },
  'Checked by Product Manager': { bg: 'bg-green-50', text: 'text-green-700', border: 'border-green-200' },
  'Ready for Deployment':   { bg: 'bg-brand-50',   text: 'text-brand-700',   border: 'border-brand-200' },
  // Tasks
